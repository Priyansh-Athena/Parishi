...
*/
    public class SGP4unit {
                ...
                char opsmode)
        {
            ...
            zf = zm + 2.0 * zes * System.Math.Sin(zm);
            sinzf = System.Math.Sin(zf);
            f2 = 0.5 * sinzf * sinzf - 0.25;
            f3 = -0.5 * sinzf * System.Math.Cos(zf);
            ses = se2 * f2 + se3 * f3;
            sis = si2 * f2 + si3 * f3;
            ...
            zf = zm + 2.0 * zel * System.Math.Sin(zm);
            sinzf = System.Math.Sin(zf);
            f2 = 0.5 * sinzf * sinzf - 0.25;
            f3 = -0.5 * sinzf * System.Math.Cos(zf);
            sel = ee2 * f2 + e3 * f3;
            ...
            if (init == 'n') {
                ...
                inclp = inclp + pinc;
                ep = ep + pe;
                sinip = System.Math.Sin(inclp);
                cosip = System.Math.Cos(inclp);
                ...
                if (inclp >= 0.2) {
                    ...
                    sinop = System.Math.Sin(nodep);
                    cosop = System.Math.Cos(nodep);
                    alfdp = sinip * sinop;
                    betdp = sinip * cosop;
                    ...
                    xls = xls + dls;
                    xnoh = nodep;
                    nodep = System.Math.Atan2(alfdp, betdp);
                    //  sgp4fix for afspc written intrinsic functions
                    // nodep used without a trigonometric function ahead
                    if ((nodep < 0.0) && (opsmode == 'a')) {
                        nodep = nodep + twopi;
                    }
                    if (System.Math.Abs(xnoh - nodep) > pi) {
                        if (nodep < xnoh) {
                            nodep = nodep + twopi;
                        } else {
                            nodep = nodep - twopi;
                ...
                )
        {
            ...
            nm = np;
            em = ep;
            snodm = System.Math.Sin(nodep);
            cnodm = System.Math.Cos(nodep);
            sinomm = System.Math.Sin(argpp);
            cosomm = System.Math.Cos(argpp);
            sinim = System.Math.Sin(inclp);
            cosim = System.Math.Cos(inclp);
            emsq = em * em;
            betasq = 1.0 - emsq;
            rtemsq = System.Math.Sqrt(betasq);
            ...
            stem = System.Math.Sin(xnodce);
            ctem = System.Math.Cos(xnodce);
            zcosil = 0.91375164 - 0.03568096 * ctem;
            zsinil = System.Math.Sqrt(1.0 - zcosil * zcosil);
            zsinhl = 0.089683511 * stem / zsinil;
            zcoshl = System.Math.Sqrt(1.0 - zsinhl * zsinhl);
            gam = 5.8351514 + 0.0019443680 * day;
            zx = 0.39785416 * stem / zsinil;
            zy = zcoshl * ctem + 0.91744867 * zsinhl * stem;
            zx = System.Math.Atan2(zx, zy);
            zx = gam + zx - xnodce;
            zcosgl = System.Math.Cos(zx);
            zsingl = System.Math.Sin(zx);
                ...
                )
        {
            ...
            if (satrec.irez != 0) {
                aonv = System.Math.Pow(nm / xke, x2o3);
                ...
                )
        {
            ...
            if (irez != 0) {
                ...
                if ((satrec.atime == 0.0) || (t * satrec.atime <= 0.0) || (System.Math.Abs(t) < System.Math.Abs(satrec.atime))) {
                    satrec.atime = 0.0;
                    satrec.xni = no;
                    satrec.xli = xlamo;
                }
                ...
                while (iretn == 381) {
                    ...
                    if (irez != 2) {
                        xndt = del1 * System.Math.Sin(satrec.xli - fasx2) + del2 * System.Math.Sin(2.0 * (satrec.xli - fasx4)) +
                                del3 * System.Math.Sin(3.0 * (satrec.xli - fasx6));
                        xldot = satrec.xni + xfact;
                        xnddt = del1 * System.Math.Cos(satrec.xli - fasx2) +
                                2.0 * del2 * System.Math.Cos(2.0 * (satrec.xli - fasx4)) +
                                3.0 * del3 * System.Math.Cos(3.0 * (satrec.xli - fasx6));
                        xnddt = xnddt * xldot;
                    } else {
                        ...
                        xndt = d2201 * System.Math.Sin(x2omi + satrec.xli - g22) + d2211 * System.Math.Sin(satrec.xli - g22) +
                                d3210 * System.Math.Sin(xomi + satrec.xli - g32) + d3222 * System.Math.Sin(-xomi + satrec.xli - g32) +
                                d4410 * System.Math.Sin(x2omi + x2li - g44) + d4422 * System.Math.Sin(x2li - g44) +
                                d5220 * System.Math.Sin(xomi + satrec.xli - g52) + d5232 * System.Math.Sin(-xomi + satrec.xli - g52) +
                                d5421 * System.Math.Sin(xomi + x2li - g54) + d5433 * System.Math.Sin(-xomi + x2li - g54);
                        xldot = satrec.xni + xfact;
                        xnddt = d2201 * System.Math.Cos(x2omi + satrec.xli - g22) + d2211 * System.Math.Cos(satrec.xli - g22) +
                                d3210 * System.Math.Cos(xomi + satrec.xli - g32) + d3222 * System.Math.Cos(-xomi + satrec.xli - g32) +
                                d5220 * System.Math.Cos(xomi + satrec.xli - g52) + d5232 * System.Math.Cos(-xomi + satrec.xli - g52) +
                                2.0 * (d4410 * System.Math.Cos(x2omi + x2li - g44) +
                                d4422 * System.Math.Cos(x2li - g44) + d5421 * System.Math.Cos(xomi + x2li - g54) +
                                d5433 * System.Math.Cos(-xomi + x2li - g54));
                        xnddt = xnddt * xldot;
                    }

                    /* ----------------------- integrator ------------------- */
                    // sgp4fix move end checks to end of routine
                    if (System.Math.Abs(t - satrec.atime) >= stepp) {
                        //iret = 0;
                        iretn = 381;
                    } else // exit here
                      {
                ...
                )
        {
            ...
            eccsq = ecco * ecco;
            omeosq = 1.0 - eccsq;
            rteosq = System.Math.Sqrt(omeosq);
            cosio = System.Math.Cos(inclo);
            cosio2 = cosio * cosio;

            /* ------------------ un-kozai the mean motion ----------------- */
            ak = System.Math.Pow(xke / satrec.no, x2o3);
            ...
            ao = System.Math.Pow(xke / satrec.no, x2o3);
            sinio = System.Math.Sin(inclo);
            po = ao * omeosq;
            ...
            if (satrec.operationmode == 'a') {
                ...
                ts70 = epoch - 7305.0;
                ds70 = System.Math.Floor(ts70 + 1.0e-8);
                tfrac = ts70 - ds70;
        ...
        public static bool sgp4init(
                Gravconsttype whichconst, char opsmode, int satn, double epoch,
                 double xbstar, double xecco, double xargpo,
                 double xinclo, double xmo, double xno,
                 double xnodeo, ref SGP4SatData satrec)
        {
            /* --------------------- local variables ------------------------ */
            ...
            qzms2t = System.Math.Pow(((120.0 - 78.0) / radiusearthkm), 4);
            x2o3 = 2.0 / 3.0;
            ...
            if ((omeosq >= 0.0) || (satrec.no >= 0.0)) {
                ...
                if (perige < 156.0) {
                    ...
                    qzms24 = System.Math.Pow(((120.0 - sfour) / radiusearthkm), 4.0);
                ...
                psisq = System.Math.Abs(1.0 - etasq);
                coef = qzms24 * System.Math.Pow(tsi, 4.0);
                coef1 = coef / System.Math.Pow(psisq, 3.5);
                ...
                satrec.cc4 = 2.0 * satrec.no * coef1 * ao * omeosq *
                        ...
                        (2.0 * etasq - eeta * (1.0 + etasq)) * System.Math.Cos(2.0 * satrec.argpo)));
                ...
                satrec.omgcof = satrec.bstar * cc3 * System.Math.Cos(satrec.argpo);
                satrec.xmcof = 0.0;
                if (satrec.ecco > 1.0e-4) {
                ...
                if (System.Math.Abs(cosio + 1.0) > 1.5e-12) {
                    satrec.xlcof = -0.25 * j3oj2 * sinio * (3.0 + 5.0 * cosio) / (1.0 + cosio);
                } else {
                    satrec.xlcof = -0.25 * j3oj2 * sinio * (3.0 + 5.0 * cosio) / temp4;
                }
                satrec.aycof = -0.5 * j3oj2 * sinio;
                satrec.delmo = System.Math.Pow((1.0 + satrec.eta * System.Math.Cos(satrec.mo)), 3);
                satrec.sinmao = System.Math.Sin(satrec.mo);
            ...
            /* constly propogate to zero epoch to initialize all others. */
            // sgp4fix take out check to let satellites process until they are actually below earth surface
            //       if(satrec.error == 0)
            int status = 0;
            Orbital.COEStruct coe;
            (status, r, v, coe) = SGP4Prop(ref satrec, 0.0);  // SEG removed gravity constant passing

            satrec.init = 'n';

            //#include "debug6.cpp"
            //sgp4fix return bool. satrec.error contains any error codes
            return (status == 0);
        }  // end sgp4init
        ...
        private static string[] errorStrings =
        {
            ...
            "7",
            "evolve time too early"
        };
        public static string Sgp4Error(int err)
        {
            if (err == 0)
                return "ok";
            return errorStrings[err - 1];
        }
         ...
         */
        public static (int error, double3 r, double3 v, Orbital.COEStruct coe) SGP4Prop(
                //Gravconsttype whichconst, // SEG removed as it should already be saved into satrec
                ref SGP4SatData satrec, double tsince)
        {
            ...
            if (satrec.isimp != 1) {
                ...
                delm = satrec.xmcof *
                        (System.Math.Pow((1.0 + satrec.eta * System.Math.Cos(xmdf)), 3) -
                        satrec.delmo);
                temp = delomg + delm;
                mm = xmdf + temp;
                argpm = argpdf - temp;
                ...
                tempa = tempa - satrec.d2 * t2 - satrec.d3 * t3 -
                        satrec.d4 * t4;
                tempe = tempe + satrec.bstar * satrec.cc5 * (System.Math.Sin(mm) -
                        satrec.sinmao);
            ...
            if (nm <= 0.0) {
                ...
                satrec.error = 2;
                // sgp4fix add return
                return (satrec.error, double3.zero, double3.zero, new Orbital.COEStruct());
            }
            am = System.Math.Pow((xke / nm), x2o3) * tempa * tempa;
            nm = xke / System.Math.Pow(am, 1.5);
            em = em - tempe;
            ...
            sinim = System.Math.Sin(inclm);
            cosim = System.Math.Cos(inclm);
            ...
            if (satrec.method == 'd') {
                sinip = System.Math.Sin(xincp);
                cosip = System.Math.Cos(xincp);
                satrec.aycof = -0.5 * j3oj2 * sinip;
                // sgp4fix for divide by zero for xincp = 180 deg
                if (System.Math.Abs(cosip + 1.0) > 1.5e-12) {
                    satrec.xlcof = -0.25 * j3oj2 * sinip * (3.0 + 5.0 * cosip) / (1.0 + cosip);
                } else {
                    satrec.xlcof = -0.25 * j3oj2 * sinip * (3.0 + 5.0 * cosip) / temp4;
                }
            }
            axnl = ep * System.Math.Cos(argpp);
            temp = 1.0 / (am * (1.0 - ep * ep));
            aynl = ep * System.Math.Sin(argpp) + temp * satrec.aycof;
            ...
            while ((System.Math.Abs(tem5) >= 1.0e-12) && (ktr <= 10)) {
                sineo1 = System.Math.Sin(eo1);
                coseo1 = System.Math.Cos(eo1);
                tem5 = 1.0 - coseo1 * axnl - sineo1 * aynl;
                tem5 = (u - aynl * coseo1 + axnl * sineo1 - eo1) / tem5;
                if (System.Math.Abs(tem5) >= 0.95) {
            ...
            pl = am * (1.0 - el2);
            Orbital.COEStruct coe = new Orbital.COEStruct();
            if (pl < 0.0) {
                //         printf("# error pl %f\n", pl);
                satrec.error = 4;
                // sgp4fix add return
                return (satrec.error, double3.zero, double3.zero, coe);
            } else {
                rl = am * (1.0 - ecose);
                rdotl = System.Math.Sqrt(am) * esine / rl;
                rvdotl = System.Math.Sqrt(pl) / rl;
                betal = System.Math.Sqrt(1.0 - el2);
                temp = esine / (1.0 + betal);
                sinu = am / rl * (sineo1 - aynl - axnl * temp);
                cosu = am / rl * (coseo1 - axnl + aynl * temp);
                su = System.Math.Atan2(sinu, cosu);
                ...
                coe.e = System.Math.Sqrt(el2);
                coe.i = xinc;
                coe.omegaU = xnode;
                coe.omegaL = argpp;
                coe.a = am * radiusearthkm;
                coe.p = coe.a * (1 - coe.e * coe.e);
                coe.nu = (su - argpp) % (2.0 * math.PI);
                if (coe.nu < 0)
                    coe.nu += 2.0 * math.PI;

                /* --------------------- orientation vectors ------------------- */
                sinsu = System.Math.Sin(su);
                cossu = System.Math.Cos(su);
                snod = System.Math.Sin(xnode);
                cnod = System.Math.Cos(xnode);
                sini = System.Math.Sin(xinc);
                cosi = System.Math.Cos(xinc);
                xmx = -snod * cosi;
                xmy = cnod * cosi;
        ...
        ///
        /// I suspect there is much in here that could be improved but I am avoiding the rabbit hole
        /// since this is external code.
        /// 
        /// </summary>
        /// <param name="propInfo"></param>
        /// <param name="index"></param>
        /// <param name="tsince"></param>
        /// <returns></returns>
        public static (int error, double3 r, double3 v, Orbital.COEStruct coe) SGP4Prop(
         //Gravconsttype whichconst, // SEG removed as it should already be saved into satrec
         ref NativeArray<SGP4Propagator.PropInfo> propInfo, int index, double tsince)
        {
            double am, axnl, aynl, betal, cosim, cnod,
                    cos2u, coseo1 = 0, cosi, cosip, cosisq, cossu, cosu,
                    delm, delomg, em, emsq, ecose, el2, eo1,
            ...
            // struct is not mutable so cannot store in SGPDATA
            int error = 0;
            ...
            x2o3 = 2.0 / 3.0;
            // sgp4fix identify constants and allow alternate values
            double[] temp5 = getgravconst(propInfo[index].satData.gravconsttype);//, tumin, mu, radiusearthkm, xke, j2, j3, j4, j3oj2 );
            tumin = temp5[0];
            mu = temp5[1];
            radiusearthkm = temp5[2];
            xke = temp5[3];
            ...
            /* ------- update for secular gravity and atmospheric drag ----- */
            xmdf = propInfo[index].satData.mo + propInfo[index].satData.mdot * tsince;
            argpdf = propInfo[index].satData.argpo + propInfo[index].satData.argpdot * tsince;
            nodedf = propInfo[index].satData.nodeo + propInfo[index].satData.nodedot * tsince;
            argpm = argpdf;
            mm = xmdf;
            t2 = tsince * tsince;
            nodem = nodedf + propInfo[index].satData.nodecf * t2;
            tempa = 1.0 - propInfo[index].satData.cc1 * tsince;
            tempe = propInfo[index].satData.bstar * propInfo[index].satData.cc4 * tsince;
            templ = propInfo[index].satData.t2cof * t2;

            if (propInfo[index].satData.isimp != 1) {
                delomg = propInfo[index].satData.omgcof * tsince;
                delm = propInfo[index].satData.xmcof *
                        (System.Math.Pow((1.0 + propInfo[index].satData.eta * System.Math.Cos(xmdf)), 3) -
                        propInfo[index].satData.delmo);
                temp = delomg + delm;
                mm = xmdf + temp;
                argpm = argpdf - temp;
                t3 = t2 * tsince;
                t4 = t3 * tsince;
                tempa = tempa - propInfo[index].satData.d2 * t2 - propInfo[index].satData.d3 * t3 -
                        propInfo[index].satData.d4 * t4;
                tempe = tempe + propInfo[index].satData.bstar * propInfo[index].satData.cc5 * (System.Math.Sin(mm) -
                        propInfo[index].satData.sinmao);
                templ = templ + propInfo[index].satData.t3cof * t3 + t4 * (propInfo[index].satData.t4cof +
                        tsince * propInfo[index].satData.t5cof);
            }

            nm = propInfo[index].satData.no;
            em = propInfo[index].satData.ecco;
            inclm = propInfo[index].satData.inclo;
            if (propInfo[index].satData.method == 'd') {
                tc = tsince;
                double[] ttemp = dspace(
                        propInfo[index].satData.irez,
                        propInfo[index].satData.d2201, propInfo[index].satData.d2211, propInfo[index].satData.d3210,
                        propInfo[index].satData.d3222, propInfo[index].satData.d4410, propInfo[index].satData.d4422,
                        propInfo[index].satData.d5220, propInfo[index].satData.d5232, propInfo[index].satData.d5421,
                        propInfo[index].satData.d5433, propInfo[index].satData.dedt, propInfo[index].satData.del1,
                        propInfo[index].satData.del2, propInfo[index].satData.del3, propInfo[index].satData.didt,
                        propInfo[index].satData.dmdt, propInfo[index].satData.dnodt, propInfo[index].satData.domdt,
                        propInfo[index].satData.argpo, propInfo[index].satData.argpdot, propInfo[index].satData.t, tc,
                        propInfo[index].satData.gsto, propInfo[index].satData.xfact, propInfo[index].satData.xlamo,
                        propInfo[index].satData.no,
                        em, argpm, inclm, mm, nodem,
                        propInfo[index].satData,
                        nm);
                // copy variables back
                em = ttemp[0];
                argpm = ttemp[1];
            ...
            if (nm <= 0.0) {
                ...
                error = 2;
                // sgp4fix add return
                return (error, double3.zero, double3.zero, new Orbital.COEStruct());
            }
            am = System.Math.Pow((xke / nm), x2o3) * tempa * tempa;
            nm = xke / System.Math.Pow(am, 1.5);
            em = em - tempe;
            ...
            mm = mm + propInfo[index].satData.no * templ;
            xlm = mm + argpm + nodem;
            emsq = em * em;
            temp = 1.0 - emsq;
            ...
            if (propInfo[index].satData.method == 'd') {
                //dpper(satrec);
                double[] ttemp = dpper(
                        propInfo[index].satData.e3, propInfo[index].satData.ee2, propInfo[index].satData.peo,
                        propInfo[index].satData.pgho, propInfo[index].satData.pho, propInfo[index].satData.pinco,
                        propInfo[index].satData.plo, propInfo[index].satData.se2, propInfo[index].satData.se3,
                        propInfo[index].satData.sgh2, propInfo[index].satData.sgh3, propInfo[index].satData.sgh4,
                        propInfo[index].satData.sh2, propInfo[index].satData.sh3, propInfo[index].satData.si2,
                        propInfo[index].satData.si3, propInfo[index].satData.sl2, propInfo[index].satData.sl3,
                        propInfo[index].satData.sl4, tsince, propInfo[index].satData.xgh2,
                        propInfo[index].satData.xgh3, propInfo[index].satData.xgh4, propInfo[index].satData.xh2,
                        propInfo[index].satData.xh3, propInfo[index].satData.xi2, propInfo[index].satData.xi3,
                        propInfo[index].satData.xl2, propInfo[index].satData.xl3, propInfo[index].satData.xl4,
                        propInfo[index].satData.zmol, propInfo[index].satData.zmos, propInfo[index].satData.inclo,
                        'n', ep, xincp, nodep, argpp, mp, propInfo[index].satData.operationmode);
                ep = ttemp[0];
                xincp = ttemp[1];
                nodep = ttemp[2];
                argpp = ttemp[3];
                ...
                if ((ep < 0.0) || (ep > 1.0)) {
                    ...
                    // sgp4fix add return
                    return (error,
                                double3.zero, double3.zero, new Orbital.COEStruct());
                }
            } // if method = d

            /* -------------------- long period periodics ------------------ */
            double aycof = 0, xlcof = 0;
            if (propInfo[index].satData.method == 'd') {
                sinip = System.Math.Sin(xincp);
                cosip = System.Math.Cos(xincp);
            ...
            axnl = ep * System.Math.Cos(argpp);
            temp = 1.0 / (am * (1.0 - ep * ep));
            aynl = ep * System.Math.Sin(argpp) + temp * aycof;
            ...
            if (pl < 0.0) {
                ...
                error = 4;
                // sgp4fix add return
                return (error, double3.zero, double3.zero, coe);
            } else {
                rl = am * (1.0 - ecose);
                rdotl = System.Math.Sqrt(am) * esine / rl;
                rvdotl = System.Math.Sqrt(pl) / rl;
                ...
                double con41 = 0, x1mth2f = 0, x7thm1 = 0;
                /* -------------- update for short period periodics ------------ */
                if (propInfo[index].satData.method == 'd') {
                    cosisq = cosip * cosip;
                ...
                mrt = rl * (1.0 - 1.5 * temp2 * betal * con41) +
                        0.5 * temp1 * x1mth2f * cos2u;
                su = su - 0.25 * temp2 * x7thm1 * sin2u;
                xnode = nodep + 1.5 * temp2 * cosip * sin2u;
                xinc = xincp + 1.5 * temp2 * cosip * sinip * cos2u;
                mvt = rdotl - nm * temp1 * x1mth2f * sin2u / xke;
                rvdot = rvdotl + nm * temp1 * (x1mth2f * cos2u +
                        1.5 * con41) / xke;
                ...
                )
        {
            ...
            switch (whichconst) {
                ...
                case Gravconsttype.wgs72:
                    ...
                    radiusearthkm = 6378.135;     // km
                    xke = 60.0 / System.Math.Sqrt(radiusearthkm * radiusearthkm * radiusearthkm / mu);
                    tumin = 1.0 / xke;
                    j2 = 0.001082616;
                    j3 = -0.00000253881;
                    j4 = -0.00000165597;
                ...
                case Gravconsttype.wgs84:
                    ...
                    break;
                default:
                    UnityEngine.Debug.LogError("unknown gravity option:" + whichconst + ", using wgs84");
        ...
        /// <summary>
        /// Using the algorithm in Appendix B of https://celestrak.org/publications/AIAA/2008-6770/AIAA-2008-6770.pdf
        /// adjust the value used for semi-major axis as suggested. 
        /// 
        /// "If you are converting from a state vector and/or an ephemeris ... you first need to convert the semi-major
        /// to a suitable mean motion for SGP4." (just after eqn 6 in Appendix B)
        /// 
        /// Code by NBP. 
        /// 
        /// </summary>
        ...
        private static A0EqnParams a0Params;
        public static double BrowerMeanToTLEMean(SGP4SatData satrec, double aE_km, double incl, double ecc)
        {
            // sgp4fix identify constants and allow alternate values
            double[] temp5 = getgravconst(satrec.gravconsttype);//, tumin, mu, radiusearthkm, xke, j2, j3, j4, j3oj2 );
            //tumin = temp5[0];
            ...
            //j3oj2 = temp5[7];
            // scale aE
            double aE = aE_km / radiusearthkm;

            double k2 = 0.5 * j2 * aE * aE;
            double cosi = System.Math.Cos(incl);

            // want to find the no that results in the desired aE
            a0Params = new A0EqnParams() {
                K = (3.0 / 2.0) * k2 * (3.0 * cosi * cosi - 1) / System.Math.Pow(1 - ecc * ecc, 3.0 / 2.0),
                xke = temp5[3],
                a0pp = aE
            };
            double n0 = xke / System.Math.Pow(aE, 3.0 / 2.0);
            double n1 = n0 * 1.01;
            double n = SecantRootFind_GE2.Secant(A0_rootEquation, n0, n1);
            return n;
        }



        private static double A0_rootEquation(double n0)
        {
            double a1 = System.Math.Pow(a0Params.xke / n0, 2.0 / 3.0);
            double delta1 = a0Params.K / (a1 * a1);
            double a0 = a1 * (1.0 - delta1 / 3.0 - delta1 * delta1 - 131.0 / 81 * delta1 * delta1 * delta1);
            double delta0 = a0Params.K / (a0 * a0);
            double a0pp = a0 / (1 - delta0);
            return a0Params.a0pp - a0pp;
        }
    } // SGP4unit
}
